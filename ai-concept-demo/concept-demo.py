...
from coursegraph import fontutil as font #폰트 모듈 호출
...
def draw_course_structure(subjects):
    fonts = font.get_system_font()
    plt.rcParams['font.family'] = fonts[0]['file']
    system_fonts = fonts[0]['file']
    if system_fonts:
        font_path = system_fonts
