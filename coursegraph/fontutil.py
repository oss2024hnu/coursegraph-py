...
def get_system_font():
    ...
    if system == 'Windows':
        ...
        font_paths = font_manager.findSystemFonts(fontpaths=None, fontext='ttf')
        apple_gothic_fonts_ttf = [font for font in font_paths if 'AppleGothic.ttf' in font.lower()]
        if apple_gothic_fonts_ttf:
            return apple_gothic_fonts_ttf
        else:
